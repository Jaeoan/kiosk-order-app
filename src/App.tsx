...
export function App() {
  ...
  }, [currentMenus, cart, selectedItem, optionStep, optionTemperature])
    ...
    <div className="w-screen h-screen overflow-hidden bg-[#C9A882] relative">
      ...
      >
        ...
        <main className="flex-1 flex gap-[14px] px-6 pt-[10px] pb-2 min-h-0 overflow-hidden">
          ...
          {/* Order Panel */}
          <aside className="flex-1 bg-white border-2 border-[#EDE0D0] rounded-[20px] flex flex-col overflow-hidden shadow-[0_2px_12px_rgba(100,70,40,0.08)]">

            <div className="px-4 py-[14px] flex items-center gap-2 text-[15px] font-bold text-[#2E1B0E] border-b-[1.5px] border-[#F0E4D4]">
            ...
            <div className="flex-1 overflow-y-auto px-[14px] py-[10px] min-h-0 scrollbar-kiosk">
              {cart.length === 0 ? (
                ...
                cart.map(c => (
                  <div key={c.id} className="flex items-center gap-[5px] py-2 border-b border-[#F7EEE3]">
            ...
            <div className="px-[14px] py-3">
              ...
              <button
                ...
                {...hoverSelectProps(handleOrder, Boolean(cart.length))}
                className={[
        ...
        <div className="bg-[#FFF6EE] border-t-2 border-[#EDE0D0] px-6 pt-[10px] pb-[14px] flex items-center gap-[14px]">
          ...
          <div className="flex gap-2 flex-1">
            {[
              ...
              { num: '8', label: '취소하기', icon: '✕',  badge: 'bg-[#D85858] text-white',   btn: 'bg-[#FFF2F2] border-[#F0B0B0] text-[#C04040] hover:bg-[#FFE4E4]', onClick: handleCancel },
            ].map(b => (
              <div key={b.num} className="flex-1 relative pt-3">
                ...
                <button
                  {...hoverSelectProps(b.onClick)}
                  className={`draw-hover-border relative w-full flex flex-col items-center justify-center gap-[3px] py-[10px] px-[6px] rounded-[14px] border-2 ${b.btn} text-[13px] font-bold cursor-pointer active:scale-95 transition-[transform,opacity] duration-100`}
                >
